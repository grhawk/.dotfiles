...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     ;; Flycheck
     (flycheck-warning ((,class (:underline (:color "yellow" :style wave) :background ,background))))
     (flycheck-error ((,class (:underline (:color "red" :style wave) :background "brown4"))))
     (flycheck-info ((,class (:underline (:color "green" :style wave) :background ,background))))
     (flycheck-fringe-warning ((,class (:foreground "yellow" :background ,background))))
     (flycheck-fringe-info ((,class (:foreground "green" :background ,background))))
     ...
     ;; Emacs interface
     (cursor ((,class (:background "RosyBrown1"))))
